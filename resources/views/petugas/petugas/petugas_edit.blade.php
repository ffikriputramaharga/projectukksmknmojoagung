        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <p class="mb-40">Formulir Pengisian Data Petugas Pendaftaraan Sebagai Petugas Perpustakaan SMK Negeri Mojoagung</p>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-10">
                                ...
                                <input type="text" name="nama_petugas"
                                    ...
                                    id="validationCustom01" placeholder="Nama Lengkap Petugas" value="{{ $petugas->name }}">
                                @error('nama_petugas')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
