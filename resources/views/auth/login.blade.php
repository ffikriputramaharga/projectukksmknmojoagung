                        ...
                        <div class="auth-form-wrap pt-xl-0 pt-70">
                            <div class="auth-form w-xl-35 w-lg-65 w-sm-85 w-100 card pa-25 shadow-lg">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <p class="text-center mb-30">Perpustakaan SMK Negeri Mojoagung</p>

                                    <div class="form-group">
                                        <input class="form-control" value="" placeholder="Nomor Induk Pegawai" type="number"
                                            name="nip">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" value="" placeholder="Password" name="password"
